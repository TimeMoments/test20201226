					...
					<table width="99%" border="0" cellpadding="0" cellspacing="0" align="center">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="78%" class="word_grey" align="left">
											&nbsp;当前位置：<span class="word_darkGrey">课程信息管理 &gt;&gt; 修改课程信息&gt;&gt;</span>
										</td>
										<td align="right">
						...
						<tr>
							<td align="center" valign="top">
								...
								<form name="form1" method="post" action="<%=request.getContextPath() %>/manage/course.do?method=edit" onsubmit="return checkForm(form1)">
									<table width="96%"  border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#D2E3E6" bordercolorlight="#FFFFFF">
										<tr align="center">
								    		...
								    		<td align="left">
								    			<input type="hidden" name="course_id" size="30" value="${map_course.course_id}"/>
								      			<input type="text" name="course_name" size="30" value="${map_course.course_name}">
									  		</td>
										</tr>
								    	<tr>

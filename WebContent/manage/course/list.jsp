							...
							<td align="center" valign="top">
								...
								<form name="studentForm" action="<%=request.getContextPath()%>/manage/course.do?method=delete" method="post" style="margin: 0px">
									<table width="96%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#67A8DB">
											...
											<tr align="center" bgcolor="#A8D8FC">
												...
												<td width="39%" bgcolor="#B2D6F1">课程名称</td>
												<td width="27%" bgcolor="#B2D6F1">加入时间</td>
												<td width="15%" bgcolor="#B2D6F1">操作</td>
												<td width="15%" bgcolor="#B2D6F1">选项</td>
											</tr>
											<%
												int i = 1;
											%>	
								<c:forEach var="map_course" items="${list_course}">	
											...
											<tr>
											    ...
											    <td align="center" style="padding:5px;">${map_course.course_name}</td>
												<td align="center">${map_course.course_time}</td>
												 <td align="center"><a href="<%=request.getContextPath()%>/manage/course.do?method=editPage&course_id=${map_course.course_id}">修改</a></td>
											    <td align="center">
											   <a href="<%=request.getContextPath()%>/manage/course.do?method=delete_radio&course_id=${map_course.course_id}">删除</a>
											    <input type="checkbox" name="delIdArray" value="${map_course.course_id}" class="noborder">

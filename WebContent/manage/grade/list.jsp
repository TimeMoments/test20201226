					...
					<table width="99%" border="0" cellpadding="0" cellspacing="0" align="center">
						...
						<tr>
							<td align="center" valign="top">
								<form action="<%=request.getContextPath() %>/manage/grade.do?method=querySelect" method="post">
								...
								<table width="96%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#67A8DB">
									...
									<c:forEach var="map_grade" items="${list_grade}">
									
									<tr>
									    <td align="center" style="padding:5px;">${map_grade.examinee_id}</td>
										<td align="center" style="padding:5px;">${map_grade.course_name}</td>
										<td align="center">${map_grade.grade_minute_use}</td>
										<td align="center">${map_grade.grade_radio_mark}</td>
									    <td align="center">${map_grade.grade_check_mark}</td>
									    <td align="center">${map_grade.grade_sum}</td>
									</tr>

					...
					<table width="99%" border="0" cellpadding="0" cellspacing="0" align="center">
						...
						<tr>
							<td align="center" valign="top">
								<form action="<%=request.getContextPath() %>/manage/subject.do?method=queryByType" method="post">
							...
							<c:forEach var="map_subject" items="${list_subject}">	
						
									<tr>
									  	<td  align="center" style="padding:5px;">${map_subject.course_name}</td>
										<td align="center">${map_subject.subject_name}</td>
										<td align="center">${map_subject.subject_type}</td>	
										<td align="center"><a href="<%=request.getContextPath() %>/manage/subject.do?method=editPage&subject_id=${map_subject.subject_id}">修改</a></td>
									    <td align="center"><input type="checkbox" name="delIdArray" value="${map_subject.subject_id}" class="noborder"></td>
									</tr>
